      ...
      <div className={cn("space-y-1.5 text-t-black", { "text-error": error })}>
        ...
        <div className="relative">
          ...
          <input
            id={id}
            className={cn(
              "flex h-9 w-full rounded-[53px] border border-solid border-stroke bg-white px-3 py-2 font-open-sans-regular text-base text-t-black outline-none transition duration-200 ease-in-out placeholder:text-t-gray focus:border-primary focus:shadow-shadow-primary disabled:cursor-not-allowed disabled:opacity-50",
              { "pl-14": startIcon },
              { "pr-14": endIcon },
              {
